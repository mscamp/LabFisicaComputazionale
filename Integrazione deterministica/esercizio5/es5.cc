...
void stampa_risultati(int N, std::vector<int> N_vec, int j_max, int k_max, double a, double b, double analytic_value, std::string f_legendre)
{
	// Stampa con numero di cifre della precisione doppia
	...
	std::cout << "Risultato Gauss (Legendre, N = 16): " << gauss(f_legendre, 16, f_gauss_legendre) << '\n';
	std::cout << "Risultato Gauss (Legendre, N = 48): " << gauss(f_legendre, 48, f_gauss_legendre) << '\n';
